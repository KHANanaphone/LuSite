...
/* ----- >>>>>>>>>>>>>>>>> NOTE:  
	 >>>>>>>>>>>>>>>>> For Carousel Slider Settings Go to line # 670 (Bottom of this page) <<<<<<<<<<<<<<<<<----- */
	 
	 
(function($) {

 $(document).ready(function() { $("#carousel").featureCarousel({  }); });
  ...
  $.fn.featureCarousel.defaults = {
    ...
    // true to prelo   ad all images in the carousel before displaying anything. If this is set to false,
